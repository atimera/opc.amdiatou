...
//    }
    ...
    /*    @Test
        public void Given_Fish_When_DisplayMenuSelected_Then_DisplayFishSentence() {
            order.displaySelectedMenu(4);
            assertEquals("Vous avez choisi comme menu : poisson\n", outContent.toString().replace("\r\n", "\n"));
        }*/
    @Test
...
/*    @Test
    public void Given_FruitJuice_When_DisplayDrinkSelected_Then_DisplayFruitJuiceSentence() {
        order.displaySelectedDrink(4);
        assertEquals("Vous avez choisi comme boisson : jus de fruit\n", outContent.toString().replace("\r\n", "\n"));
    }*/
